    ...
    <div className={g.filterType}>
      ...
      <div id="color" className={classNames(g.hideEffect, g.hidePanel)}>
        <div className={g.scroll}>
          {colors.map((val, i) => (
            <div className={g.checkBlock} key={i}>
              <input
                ...
                onChange={(e) =>
                  setState(BussinesLogic.generateDate(e, state, val))
                }
                type="checkbox"
                name="color"
                value={val}
              ...
              >
                <div className={s.content}>
                  <div className={s.box} style={{ backgroundColor: val }}></div>
          ...
          <div className={g.checkBlock}>
            <input
              ...
              className={classNames(g.checkbox_input, props.title)}
              onChange={(e) =>
                setState(BussinesLogic.generateDate(e, state, "colored"))
              }
              type="checkbox"
              name="color"
              value="colored"
        ...
        <div className={g.buttons}>
          <button className={g.button} onClick={(e) => clear()}>
            clear
          </button>
